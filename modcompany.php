...
// END - check new entries for company users are OK - GreenFlatDog    
    ...
    $xoopsDB->query("update ".$xoopsDB->prefix("jobs_companies")." set comp_id='$comp_id', comp_name='$comp_name', comp_address='$comp_address', comp_address2='$comp_address2', comp_city='$comp_city', comp_state='$comp_state', comp_zip='$comp_zip', comp_phone='$comp_phone', comp_fax='$comp_fax', comp_img='$comp_img_old',  comp_url='$comp_url', comp_usid='$comp_usid', comp_user1='$comp_userid1', comp_user2='$comp_userid2', comp_contact='$comp_contact', comp_user1_contact='$comp_user1_contact', comp_user2_contact='$comp_user2_contact', comp_date_added='$comp_date_added' where comp_id=".mysql_real_escape_string($comp_id)."");
	...
	$result = $xoopsDB->query("select comp_id, comp_name, comp_address, comp_address2, comp_city, comp_state, comp_zip, comp_phone, comp_fax, comp_url, comp_img, comp_usid, comp_user1, comp_user2, comp_contact, comp_user1_contact, comp_user2_contact, comp_date_added from ".$xoopsDB->prefix("jobs_companies")." where comp_id=".mysql_real_escape_string($comp_id)."");
...
// END - check new entries for company users are OK - contributed by GreenFlatDog
	$result = $xoopsDB->query("select name from ".$xoopsDB->prefix("jobs_region")." order by rid");
	ob_start();
