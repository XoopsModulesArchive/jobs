...
include XOOPS_ROOT_PATH."/header.php";
	...
	$sql = "select r.lid, r.cid, r.name, r.title, r.exp, r.expire, r.private, r.tel, r.salary, r.typeprice, r.date, r.email, r.submitter, r.usid, r.town, r.state, r.valid, r.resume, r.view, c.res_lid, c.lid, c.made_resume, c.date, c.usid FROM ".$xoopsDB->prefix("jobs_resume")." r LEFT JOIN ".$xoopsDB->prefix("jobs_created_resumes")." c ON c.lid = r.lid WHERE r.lid = ".mysql_real_escape_string($lid)."";
