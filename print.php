...
function Rprint($lid=0)
{
	...
	$result = $xoopsDB->query("select lid, name, title, exp, private, tel, salary, typeprice, date, email, submitter, town, state FROM ".$xoopsDB->prefix("jobs_resume")." where lid=".mysql_real_escape_string($lid)."");
