...
$modversion['config'][15]['options'] = array($cloned_lang."_ORDREALPHA"=>'title DESC', $cloned_lang."_ORDREPERSO"=>'ordre DESC');
...
$modversion['config'][16]['options'] = array('_MI_JOBS_ORDER_TITLE'=>'title DESC', '_MI_JOBS_ORDER_COMPANY'=>'company DESC', '_MI_JOBS_ORDER_TOWN'=>'town DESC', '_MI_JOBS_ORDER_DATE'=>'date DESC', '_MI_JOBS_ORDER_POP'=>'view DESC');
...
$modversion['config'][35]['default'] = 'dhtml';
...
$modversion['config'][36]['default'] = 'dhtml';
xoops_load('xoopseditorhandler');
$editor_handler = XoopsEditorHandler::getInstance();
