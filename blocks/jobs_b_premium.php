...
// End
	...
	$result = $xoopsDB -> query ("SELECT c.comp_id, c.comp_name, c.comp_img, l.lid, l.title, l.type, l.company, l.typeprice, l.town, l.state, l.date, l.view FROM ".$xoopsDB->prefix("jobs_companies")." AS c LEFT OUTER JOIN ".$xoopsDB->prefix("jobs_listing")." AS l on c.comp_name = l.company WHERE l.valid = 'Yes' and l.status!='1' and l.premium='1' $cat_perms");
