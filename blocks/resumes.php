...
function resume_show($options)
{
	...
	$result = $xoopsDB->query("SELECT lid, cid, name, title, exp, expire, private, tel, salary, typeprice, date, email, submitter, usid, town, state, valid, resume, rphoto, view FROM ".$xoopsDB->prefix("".$blockdirname."_resume")." WHERE valid='Yes' and status!='1' ORDER BY ".$options[0]." DESC",$options[1],0);
	...
	$block['link'] = "<a href=\"".XOOPS_URL."/modules/$blockdirname/reumes.php\"><b>".constant($block_lang."_ALL_LISTINGS")."</b></a>";
	$block['add'] = "<a href=\"".XOOPS_URL."/modules/$blockdirname/reumes.php\"><b>".constant($block_lang."_ADDRESNOW")."</b></a>";
